...
export async function POST() {
    try {
        ...
        const updatingChampionshipReigns = Object.entries(group).reduce(
            (acc: any, [_, value]: [string, any]) => {
        ...
        const affectedRows = updatingChampionshipReigns.reduce(
            async (accumulator: number, element: any) => {
