    ...
    return (
        <>
            <Actions.Container>
                ...
                <Actions.Link color={Actions.Colors.DEFAULT} toHref={`/admin/wrestlers/update/${wrestler.id}`} icon="pencil-square" text="Update Wrestler" />
                <form action="" method='POST'>
                    <Actions.Submit color={Actions.Colors.WARNING} icon="trash-fill" text="Delete Wrestler" name="wrestler_id" value={wrestler.id.toString()} />
                </form>
            </Actions.Container>
